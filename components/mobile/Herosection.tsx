...
export default function HeroSection() {
  ...
  return (
    <section className="w-full px-3 sm:px-4 pt-3 sm:pt-4">
      <div
        ref={sectionRef as any}
        className="relative isolate flex min-h-[92vh] flex-col overflow-hidden rounded-[28px] sm:rounded-[36px]"
      >
        {/* Sky background */}
        ...
        <div className="mx-auto flex w-full max-w-5xl flex-1 flex-col items-center px-6 pt-20 text-center sm:pt-32">
          <motion.div
          ...
          <div className="mt-8 flex w-full flex-1 items-center justify-center sm:mt-10 sm:items-end">
            <div
              ref={phoneWrapRef}
